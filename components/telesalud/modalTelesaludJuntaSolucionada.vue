            ...
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-row dense v-if="telesalud">
                        ...
                        <v-col cols="12" sm="12" md="12"
                            v-if="telesalud.integrantes && telesalud.integrantes.length > 0">
                            <v-alert text dense border="left" type="info" icon="mdi-account-group" class="text-center">
                                <b>Integrantes - Junta de Profesionales</b>
                            </v-alert>

                            <ul class="integrantes-list">
                                <li v-for="item in telesalud?.integrantes" :key="item.id">
                        ...
                        <v-col cols="12" sm="12" md="12">
                            <v-alert text dense border="left" type="info" icon="mdi-message-alert-outline"
                                class="text-center">
                                <b>Respuesta Junta de Profesionales</b>
                            </v-alert>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                        ...
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field dense outlined readonly label="Institución Prestadora"
                                :value="gestionRespuesta?.institucion_prestadora?.nombre || '-'"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field dense outlined readonly label="EAPB"
                                :value="gestionRespuesta?.eapb?.nombre || '-'"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                            <v-textarea auto-grow dense outlined readonly
                                label="Evaluación de la Junta de Profesionales"
                                :value="gestionRespuesta?.evaluacion_junta || '-'"></v-textarea>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field dense outlined readonly label="¿La Junta de Profesionales de Salud Aprueba?"
                                :value="gestionRespuesta?.junta_aprueba || '-'"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field dense outlined readonly
                                label="Clasificación de Prioridad de Servicio Ambulatorio"
                                :value="gestionRespuesta?.clasificacion_prioridad || '-'"></v-text-field>
                        </v-col>
                    </v-row>
                </v-card-text>
                <v-card-actions>
