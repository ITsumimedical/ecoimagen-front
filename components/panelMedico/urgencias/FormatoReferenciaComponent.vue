<template>
    <div>
        <v-card>
            ...
            <v-dialog v-model="dialogoCrear" persistent width="1250" v-if="dialogoCrear">
                <v-card>
                        ...
                        <v-form ref="evolucion">
                            <v-row>
                                ...
                                <v-col cols="12" sm="12" md="6">
                                    <v-autocomplete v-model="formulario.entidad_id" :items="entidades"
                                        item-text="nombre" label="Entidad a donde se remite" item-value="id" dense
                                        outlined solo no-data-text="Por favor escriba el nombre del diagnostico"
                                        required :rules="rules.entidad_id">
                                    </v-autocomplete>
                                </v-col>
                                <v-col cols="12" md="6" sm="12">
                    ...
                    <v-card-actions>
                        ...
                        <v-btn color="success" small dark @click="guardarReferencia()">Guardar</v-btn>
                    </v-card-actions>
                </v-card>
    ...
    export default {
        ...
        data() {
            return {
                ...
                datosAdmision: {},
                rules: {
                    servicio_remision: [(v) => !!v || "El campo servicio remision es requerido"],
                    entidad_id: [(v) => !!v || "El campo entidad donde se remite es requerido"],
                    fecha_referencia: [(v) => !!v || "El campo fecha es requerido"],
                    objeto_remision: [(v) => !!v || "El campo objeto de la remision es requerido"],
                },
                listaHistorico: []
            }
        },
        ...
        methods: {
            ...
            listarAdmisionesUrgencias() {
                this.preload = true
                this.$axios.get('epicrisis/listarRemision').then(res => {
                    this.preload = false
            ...
            guardarReferencia() {
                ...
                this.setPreload(true)
                this.formulario.epicrisis = this.datosAdmision.idEpicrisis
                this.formulario.admision_urgencia_id = this.datosAdmision.id
                this.$axios.post('epicrisis/registroReferencia', this.formulario).then(res => {
