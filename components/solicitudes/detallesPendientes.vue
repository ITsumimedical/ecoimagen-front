                ...
                <v-form ref="form" v-model="valid" lazy-validation>
                    <v-card-text>
                        <v-row dense>
                            ...
                            <v-col cols="12" sm="12" md="12">
                                <v-alert border="left" dense text color="blue-grey" icon="mdi-attachment">
                                    <b>Archivos Adjuntos</b>
                                </v-alert>
                            </v-col>
                            <v-col cols="12" sm="12" md="12" v-if="solicitud.adjunto_radicado"
                            ...
                            <v-col cols="12" sm="12" md="12">
                                <v-alert border="left" dense text color="green darken-1" icon="mdi-gesture-double-tap">
                                    <b>Acciones</b>
                                </v-alert>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                            ...
                            <v-col cols="12" sm="12" md="12" v-if="gestionSolicitud.accion.id === 3">
                                <v-autocomplete label="Áreas" v-model="gestionSolicitud.areas" multiple small-chips
                                    deletable-chips :items="areasSolicitudes" :loading="loading.areas" dense
