        ...
        <v-row dense class="mt-4">
            ...
            <v-col cols="12" md="12" sm="12">
                <v-data-table disable-pagination hide-default-footer loading-text="Cargando... Por favor espere"
                    :items="asignadas" :headers="headersAsignadas" :loading="loadings.asignadas"
...
export default {
    ...
    methods: {
        listarBarrerasAsignadas() {
            ...
            this.$axios.post('/barrera-acceso/listar-barreras-asignadas?page=' + this.pagina + "&cant=" + this.opcionActual, data)
                .then((res) => {
