<template>
    <div>
                ...
                <v-toolbar flat>
                    <v-toolbar-title>
                        <div class="d-flex align-center">
                            ...
                            <span>Autorización - Medicamentos</span>
                        </div>
                    </v-toolbar-title>
        ...
        <!-- Modal Gestionar Auditoría -->
        <modal-gestionar-auditoria-medicamentos
...
<script>
import ModalGestionarAuditoriaMedicamentos
    from '~/components/ordenamiento/medicamentos/modalGestionarAuditoriaMedicamentos.vue'

export default {
    components: {
        ModalGestionarAuditoriaMedicamentos
    },
    middleware({$can, redirect}) {
        if (!$can('autorizacion.medicamentos')) return redirect('/');
    },
    data() {
        return {
            loading: {
    ...
    methods: {
        ...
        async listarOrdenes() {
            ...
            try {
                ...
                const response = await this.$axios.post('/auditoria/listar-ordenes-medicamentos-por-auditar', data);
