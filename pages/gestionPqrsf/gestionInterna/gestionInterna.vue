  ...
  <v-card elevation="0">
      ...
      <v-toolbar flat>
        <v-toolbar-title>
          <div class="d-flex align-center">
            ...
            <span>Gestión Interna - PQRF</span>
          </div>
        </v-toolbar-title>
    ...
    <v-card-text>
      <v-tabs v-model="tab" grow @change="onTabChange">
        ...
        <!-- Tab Pendientes (Rojo) -->
        <v-tab key="gestionInternaPendientes" class="pendientes-tab">
        ...
        <!-- Tab Asignadas (Azul) -->
        <v-tab key="gestionInternaAsignadas" class="asignados-tab">
        ...
        <v-tab key="gestionInternaPreSolucionadas" class="presolucionadas-tab">
        ...
        <v-tab key="gestionInternaSolucionadas" class="solucionadas-tab">
        ...
        <v-tabs-items v-model="tab">
          <v-tab-item key="gestionInternaPendientes">
            <gestionInternaPendientes
              ref="gestionInternaPendientes"
              @actualizarConteo="actualizarContadorPendientes"
            />
          </v-tab-item>
          <v-tab-item key="gestionInternaAsignadas">
            <gestionInternaAsignados
              ref="gestionInternaAsignadas"
              @actualizarConteo="actualizarContadorAsignados"
            />
          </v-tab-item>
          <v-tab-item key="gestionInternaPreSolucionadas">
            <gestionInternaPresolucionados
              ref="gestionInternaPreSolucionadas"
              @actualizarConteo="actualizarContadorPreSolucionados"
            />
          </v-tab-item>
          <v-tab-item key="gestionInternaSolucionadas">
            <gestionInternaSolucionados
              ref="gestionInternaSolucionadas"
...
<script>
import gestionInternaPendientes from "~/pages/gestionPqrsf/gestionInterna/gestionInternaPendientes.vue";
import gestionInternaAsignados from "~/pages/gestionPqrsf/gestionInterna/gestionInternaAsignados.vue";
import gestionInternaPresolucionados from "~/pages/gestionPqrsf/gestionInterna/gestionInternaPresolucionados.vue";
import gestionInternaSolucionados from "~/pages/gestionPqrsf/gestionInterna/gestionInternaSolucionados.vue";
    ...
    onTabChange(tab) {
      ...
      switch (tab) {
        case 0: // Primer tab (Pendientes)
          if (this.$refs.gestionInternaPendientes) {
            this.$refs.gestionInternaPendientes.listarPQRSFPendientes();
          }
          break;
        case 1: // Segundo tab (Asignadas)
          if (this.$refs.gestionInternaAsignadas) {
            this.$refs.gestionInternaAsignadas.listarPQRSFAsignados();
          }
          break;
        case 2: // Tercer tab (Pre-Solucionadas)
          if (this.$refs.gestionInternaPreSolucionadas) {
            this.$refs.gestionInternaPreSolucionadas.listarPQRFPreSolucionados();
          }
          break;
        case 3: // Cuarto tab (Solucionadas)
          if (this.$refs.gestionInternaSolucionadas) {
            this.$refs.gestionInternaSolucionadas.listarPQRFSolucionadas();
          }
          break;
        default:
